...
/// </summary>
internal static class SessionHeaderWriterFactory
{
    /// <summary>
    ...
    internal static ISessionHeaderWriter Create(EncryptionOptions options)
    {
        return options.Version switch
        {
            1 => new SessionHeaderWriterV1(new HeaderEncryptorV1(options), options.KeyId),
