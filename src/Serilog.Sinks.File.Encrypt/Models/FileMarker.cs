...
internal static class FileMarker
{
    ...
    internal static readonly byte[] Header = [0xFF, 0xFE, 0x4C, 0x4F, 0x47, 0x48, 0x44, 0x00, 0x01];
    internal static readonly byte[] Message = [0xFF, 0xFE, 0x4C, 0x4F, 0x47, 0x42, 0x44, 0x00, 0x02];
    // csharpier-ignore-end
    
    internal static readonly int MarkerLength = Header.Length;
    ...
    /// </summary>
    public static bool IsValidHeader(FileStream stream, long markerPosition)
    {
